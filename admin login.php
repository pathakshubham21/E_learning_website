...
<body style="background-color: #ebf6f7">
		<div style="height: 80px; background-color: black;">
			...
			<input type="button" value="Home" onclick="window.location.href='main page.php'"  style="color: white; border-radius: 5%; float:right; background-color:#ffbd31; color: black; height: 30px;width: 100px; border: solid 1px #c2c4c6; font-size:16px; padding-left:10px;margin-top: 30px;margin-right: 30px;">

		

	</div>
<h3 align="center"> Aws Admin Login</h3>
...
<p style="margin-left:-100px;margin-bottom:0px;"> Enter Email or Phone Number*</p>
		...
		<tr align=center >
			<td>
				...
				<input type="button" value="Sign In" onclick="check();"  style="color: black; border-radius: 7%;background-color: orange; height: 30px;width: 150px; border: solid 1px #c2c4c6; font-size:16px; padding-left:10px; margin: 20px;">
