...
<div style="height: 80px; background-color: black;">
	...
	<h3 style="margin-top: -400px;margin-left:700px;"> Admin Controls </h3>
<button  style="position: absolute;left:350px;top:150px; width: 900px;" type="button" onclick="window.location.href='admin show data.php'" class="btn btn-success btn-lg btn-block" >View Student Data</button>
<button  style="position: absolute;left:350px;top:250px;width: 900px;" type="button" onclick="window.location.href='admin admit.php'" class="btn btn-success btn-lg btn-block">Admit Student / Suspend Student</button> 
<button  style="position: absolute;left:350px;top:350px;width: 900px;" type="button" onclick="window.location.href='admin exam.php'"  class="btn btn-success btn-lg btn-block">View Test Details</button>
<button  style="position: absolute;left:350px;top:450px;width: 900px;" type="button" onclick="f1();"  class="btn btn-success btn-lg btn-block">Add Question / Remove Question</button>
<br>
<br>
<p style="margin-top: 370px;margin-left: 500px;">
	Privacy Statement | Terms of Use | © 2019 Lovely Professional University. All Rights Reserved<br>Doveloper | @shubham Pathak | Toll Free +91 1800 00 5212 |</p><br><br><br>
